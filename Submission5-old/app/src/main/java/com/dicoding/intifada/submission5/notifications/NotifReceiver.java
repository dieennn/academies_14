package com.dicoding.intifada.submission5.notifications;
...
public class NotifReceiver extends BroadcastReceiver {
    ...
    private void showDailyReminder(Context context) {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context, CHANNEL_ID)
                .setSmallIcon(R.drawable.ic_live_tv_24dp)
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_live_tv_24dp))
    ...
    public void setReleaseTodayReminder() {
        ...
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        Objects.requireNonNull(alarmManager).setInexactRepeating(AlarmManager.RTC_WAKEUP, getReminderTimeRelease().getTimeInMillis(), AlarmManager.INTERVAL_DAY, pendingIntent);
    }
