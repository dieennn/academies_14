package com.dicoding.intifada.sm5.mydbentity;

import android.database.Cursor;
import android.os.Parcel;
import android.os.Parcelable;

import com.dicoding.intifada.sm5.mydb.DatabaseContract;

import static com.dicoding.intifada.sm5.mydb.DatabaseContract.getColumnDouble;
import static com.dicoding.intifada.sm5.mydb.DatabaseContract.getColumnInt;
import static com.dicoding.intifada.sm5.mydb.DatabaseContract.getColumnString;
...
public class MoviesModel implements Parcelable {
    ...
    public MoviesModel(int id, String title, String release_date, Double vote_average, String vote_count,
                       String overview, String poster_path, String backdrop_path, String login, String avatar_url) {
        this.id = id;
        this.title = title;
        this.release_date = release_date;
        this.vote_average = vote_average;
    ...
    public MoviesModel(Cursor cursor) {
        ...
        this.login = getColumnString(cursor, DatabaseContract.MovieColumns.COLUMN_LOGIN);
        this.avatar_url = getColumnString(cursor, DatabaseContract.MovieColumns.COLUMN_AVATAR_URL);
    }
