...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final int SCHEDULE_OF_PERIOD = 30000;
    ...
    private void startJob() {
        @SuppressLint("JobSchedulerService") ComponentName mServiceComponent =
                new ComponentName(this, UpdateWidgetService.class);
