package com.dicoding.intifada.submission4.adapter;
...
import com.dicoding.intifada.submission4.CustomOnItemClickListener;
...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.FavoriteViewHolder> {
    ...
    public FavoriteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_favorite,
                parent, false);
